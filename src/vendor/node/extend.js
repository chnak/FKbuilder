...
export default function(paper) {
    // Note: require.extensions is deprecated in Node.js and not available in ESM
    // PaperScript .pjs extension support is not available in ESM mode
    // Users should use regular JavaScript files instead
    if (paper.PaperScript) {
        ...
        // In ESM, require.extensions is not available
        // PaperScript .pjs files are not supported in ESM mode
        // This functionality would need to be reimplemented using ESM loaders
        console.warn('[Paper.js] PaperScript .pjs extension is not supported in ESM mode. Please use regular JavaScript files.');
    }
